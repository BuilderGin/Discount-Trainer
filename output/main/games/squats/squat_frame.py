...
def squats(self):
    ...
    """
    Create a Squat Game Frame
    :param: Created a Squat Game Frame and Start Webcam so later wont lagg
    :return: Squat Game Frame & start Webcam for later use
    """
    ...
    # Starting the webcam earlyer so the game won't lagg
